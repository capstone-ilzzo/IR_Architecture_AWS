...
def lambda_handler(event, context):
    try:
        ...
        s3_upload_command = f"aws s3 cp - s3://ilzzo-forensic-artifact/{s3_prefix}{instance}.lime"
        ...
        commands1 = [
            ...
            'aws s3 cp s3://ilzzo-forensic-artifact/memory-modules/lime-6.1.66-93.164.amzn2023.x86_64.ko /tmp/lime.ko',
        ...
        s3_export = {
            'ArtifactRoot': f's3://ilzzo-forensic-artifact/{s3_prefix}',
